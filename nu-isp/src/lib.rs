...
pub fn get_partinfo(pdid: u32) -> Option<PartInfo> {
    let pdid_map = pdid_map! {
        ...
        /* NUC1261 */
        NUC1261NE4AE { 0x01205206, 128*1024 },
        NUC1261LE4AE { 0x01205205, 128*1024 },
        NUC1261LG4AE { 0x01205204, 256*1024 },
        NUC1261SE4AE { 0x01205213, 128*1024 },
        NUC1261SG4AE { 0x01205212, 256*1024 },
        /* NUC029 */
        ...
        /* M252 */
        M252FC2AE { 0x00F252B0, 32*1024 },
        M252EC2AE { 0x00F252A1, 32*1024 },
        M252ZC2AE { 0x00F252E2, 32*1024 },
        M252ZD2AE { 0x00F252C2, 64*1024 },
        M252LC2AE { 0x00F25204, 32*1024 },
        M252LD2AE { 0x00F25201, 64*1024 },
        M252LE3AE { 0x00F25205, 128*1024 },
        M252LG6AE { 0x00F25202, 256*1024 },
        M252SC2AE { 0x00F25213, 32*1024 },
        M252SD2AE { 0x00F25210, 64*1024 },
        M252SE3AE { 0x00F25214, 128*1024 },
        M252SG6AE { 0x00F25211, 256*1024 },
        M252KE3AE { 0x00F25243, 128*1024 },
        M252KG6AE { 0x00F25240, 256*1024 },
        /* M253 */
        M253ZE3AE { 0x00F250E0, 128*1024 },
        M253LD3AE { 0x00F25000, 64*1024 },
        M253LE3AE { 0x00F25001, 128*1024 },
    };
    pdid_map(pdid)
}
